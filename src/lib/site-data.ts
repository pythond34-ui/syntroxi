...
export const systems = [
  ...
  {
    title: "Human handoff",
    detail: "Confidence thresholds route edge cases to the right person with a full brief attached.",
  },
  {
    title: "Audit and control",
    detail:
      "Every decision is logged, replayable and attributable. SOC 2 aligned from the first deployment.",
  },
];
...
export const industries = [
  {
    ...
    icon: Scale,
    detail: "Onboarding, KYC review, reconciliation and client reporting under strict audit trails.",
